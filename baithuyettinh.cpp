...
void chiamang(int a[], int b[])	{
    ...
    float temp[max];	// dung de luu kq trung gian cua phep nhan trong qua trinh chia
    ...
    // fleng(sodu) tra ve bac cao nhat cua phan du
	{
	    ...
	    for(int i=0;i<=max;i++) temp[i]=0; //mang temp[] se duoc reset ve gia tri 0 de luu tru tam thoi ket qua cua phep nhan trong buoc tiep theo.
